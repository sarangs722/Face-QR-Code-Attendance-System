package com.sarangs722.qrversion11.faceRecog.models
...
class FaceNetModel(
    context: Context,
    var model: com.sarangs722.qrversion11.faceRecog.models.ModelInfo,
    useGpu: Boolean,
    useXNNPack: Boolean) {
    ...
    private val imageTensorProcessor = org.tensorflow.lite.support.image.ImageProcessor.Builder()
